<%@ Page Language="C#" MasterPageFile="~/App_Resources/default.master" AutoEventWireup="true"
    ...
    MetaDescription="On this page you will be able to view, sort, edit, and delete PFC employee profiles"
...
<asp:Content ContentPlaceHolderID="BodyContentPlaceholder" runat="Server">
    <h1 class="title-regular">
		Employee Records</h1>
    <p>
		On this page you will be able to view, sort, edit, and delete PFC employee profiles.
    </p>
    ...
    <asp:UpdatePanel ID="upd" runat="server">
        <ContentTemplate>
            ...
            <div class="clearfix align-right">
				...
				<asp:LinkButton SkinID="AltLinkButton" OnClientClick="return confirm('Are you sure you want to delete all of these employees?');"
